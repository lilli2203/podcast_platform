...
const formSchema = z.object({
  podcastTitle: z.string().min(2, { message: "Title must be at least 2 characters long" }),
  podcastDescription: z.string().min(2, { message: "Description must be at least 2 characters long" }),
})
...
const CreatePodcast = () => {
  ...
  return (
    <section className="mt-10 flex flex-col">
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(handleSubmit)} className="mt-12 flex w-full flex-col">
